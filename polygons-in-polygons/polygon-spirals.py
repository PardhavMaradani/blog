...
def draw_polygon_spiral(sides, cx, cy, length, levels):
  delta = 10  # spacing
  ...
  for level in range(levels):
    ...
    draw_polygon(sides, cx, cy, length, (rangle * level))
...
draw_polygon_spiral(3, -ww/4, 0, length, levels)
draw_polygon_spiral(4, 0, 0, length, levels)
draw_polygon_spiral(5, ww/4, 0, length, levels)
